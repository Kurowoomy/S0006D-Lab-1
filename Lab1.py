...
student1 = Entities.Student(0, "Student 1", Enumerations.location_type.school, 4, 10, 0, 1, 0, 100, 9)
student2 = Entities.Student(1, "Student 2", Enumerations.location_type.school, 0, 0, 2, 15, 0, 0, 10)
memberOfSociety1 = Entities.Worker(2, "Miner 1", Enumerations.location_type.mines, 0, 0, 0, 15, 0, 0, 0)
